...
if __name__ == "__main__":
    ...
    for train_index, eval_index in kfold.split(X):
        ...
        model.add(Conv2D(filters=4, kernel_size=(5,5), padding='Same',# kernel_regularizer=regularizers.l2(0.01),
                        activation='relu', input_shape=(77,77,3)))
        model.add(MaxPool2D(pool_size=(2,2), strides=(2,2)))

        model.add(Conv2D(filters=100, kernel_size=(5,5), padding='Same',# kernel_regularizer=regularizers.l2(0.01),
                        activation='relu'))
        model.add(MaxPool2D(pool_size=(2,2), strides=(2,2)))
